-- One-time recovery after applying 029. Remove only the exact 2026-08-14
-- terminal failure when it has no durable topic, artifact, model or publish
-- output. Any observable work makes this migration fail closed.
...
begin
  ...
  if v_status is distinct from 'failed'
    ...
    raise exception using errcode = 'P0001', message = 'REDISCOVERY_FAILED_RUN_RESET_REFUSED';
  end if;
